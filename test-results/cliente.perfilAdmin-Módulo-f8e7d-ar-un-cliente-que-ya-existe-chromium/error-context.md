...
- Name: cliente.perfilAdmin.spec.js >> Módulo de Clientes - Perfil Admin >> Muestra un mensaje de error si se intenta crear un cliente que ya existe
- Location: tests\cliente.perfilAdmin.spec.js:128:7
...
Call log:
  - waiting for locator('text=El cliente ya existe')
        ...
        - generic [ref=e137]:
          ...
          - generic [ref=e155]:
            - table [ref=e157]:
              ...
              - rowgroup [ref=e206]:
                ...
                - row [ref=e473] [cursor=pointer]:
                  - cell "00017" [ref=e474]
                  - cell "Cliente E2E Playwright 1788120269551" [ref=e475]
                  - cell "20-61532314-5" [ref=e476]
                  - cell "-" [ref=e477]
                  - cell "-" [ref=e478]
                  - cell "-" [ref=e479]
                  - cell "-" [ref=e480]
            ...
            - navigation "Pagination" [ref=e493]:
              - paragraph [ref=e495]: Mostrando 1 a 15 de 94 resultados
              - generic [ref=e496]:
